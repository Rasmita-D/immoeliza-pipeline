...
async def main():
    ...
    n = 301     #start counting at page number n on immoweb url below
    session = Session()
    tasks = [scrape_list_of_houses(session, f"https://www.immoweb.be/en/search/house-and-apartment/for-sale?countries=BE&isAPublicSale=false&isALifeAnnuitySale=false&page={n + i}&orderBy=relevance") for i in range(32)] #repeat i times
