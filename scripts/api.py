...
REPO_URL = 'https://github.com/adheeba/immo-eliza-deployment.git'
BRANCH = 'dag_test'
REPO = 'immo-eliza-deployment'
SOURCE_FILE = 'models/xgboost.pkl'
...
with DAG(
    ...
    clone_repo = BashOperator(
        ...
        bash_command=(
            ...
            f'cp $AIRFLOW_HOME/{SOURCE_FILE} {TARGET_FILE} &&'
            f'git add {TARGET_FILE} && '
            'git commit -m "Replaced xgboost model via Airflow" && '
